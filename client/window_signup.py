from tkinter import Toplevel,Button,Label,Entry,Frame,END,LEFT
from config import *

class WindowSignUp(Toplevel):
    """注册窗口"""
    ...
    def add_widgets(self):
        ...
        # '登录'按钮
        login_button = Button(button_frame, name = 'signup_button')
    ...
    def on_signup_button_click(self, command):
        '''注册按钮的事件注册'''
        login_button = self.children['button_frame'].children['signup_button']
